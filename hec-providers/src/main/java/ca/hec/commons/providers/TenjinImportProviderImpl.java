...
//      eMap.put("noType", "");
        ...
        gMap.put("Professeur(e) associÃ©(e)", "CONTACT_TITLE_ADJUNCTPROFESSOR");
        gMap.put("Professeur(e) affiliÃ©(e)", "CONTACT_TITLE_AFFILIATEDPROFESSOR");
        gMap.put("Professeur(e) adjoint(e)", "CONTACT_TITLE_ASSISTANTPROFESSOR");
        gMap.put("Professeur(e) agrÃ©gÃ©(e)", "CONTACT_TITLE_ASSOCIATEPROFESSOR");
        gMap.put("MaÃ®tre d'enseignement", "CONTACT_TITLE_FULLTIMEFACULTYLECTURER");
        gMap.put("AttachÃ©(e) d'enseignement", "CONTACT_TITLE_FULLTIMELECTURER");
        gMap.put("Professeur(e) invitÃ©(e)", "CONTACT_TITLE_GUESTPROFESSOR");
        gMap.put("Professeur(e) honoraire", "CONTACT_TITLE_HONORARYPROFESSOR");
        gMap.put("ChargÃ©(e) de cours", "CONTACT_TITLE_PARTTIMEFACULTYLECTURER");
        gMap.put("ChargÃ©(e) d'enseignement", "CONTACT_TITLE_PARTTIMELECTURER");
        gMap.put("Professeur(e) titulaire", "CONTACT_TITLE_PROFESSOR");
        gMap.put("SecrÃ©taire", "CONTACT_TITLE_SECRETARY");
        gMap.put("Ã‰tudiant(e)", "CONTACT_TITLE_STUDENT");
        ...
        gMap.put("Responsable de formaciÃ³n", "CONTACT_TITLE_FULLTIMEFACULTYLECTURER");
        gMap.put("Responsable de formaciÃ³n", "CONTACT_TITLE_FULLTIMELECTURER");
        gMap.put("Profesor visitante", "CONTACT_TITLE_GUESTPROFESSOR");
        gMap.put("Profesor emÃ©rito", "CONTACT_TITLE_HONORARYPROFESSOR");
        gMap.put("Docente de tiempo parcial", "CONTACT_TITLE_PARTTIMEFACULTYLECTURER");
        gMap.put("Responsable de formaciÃ³n parcial", "CONTACT_TITLE_PARTTIMELECTURER");
